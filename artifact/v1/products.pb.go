...
type ProductObjectDeleteRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// @gotags: json:"type" validate:"required,oneof=image binary"
	Type string `protobuf:"bytes,2,opt,name=Type,proto3" json:"type" validate:"required,oneof=image binary"`
	// @gotags: validate:"required,oneof=dev test"
	Branch string `protobuf:"bytes,3,opt,name=Branch,proto3" json:"Branch,omitempty" validate:"required,oneof=dev test"`
}

func (x *ProductObjectDeleteRequest) Reset() {
	*x = ProductObjectDeleteRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_artifact_v1_products_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ProductObjectDeleteRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductObjectDeleteRequest) ProtoMessage() {}

func (x *ProductObjectDeleteRequest) ProtoReflect() protoreflect.Message {
	mi := &file_artifact_v1_products_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductObjectDeleteRequest.ProtoReflect.Descriptor instead.
func (*ProductObjectDeleteRequest) Descriptor() ([]byte, []int) {
	return file_artifact_v1_products_proto_rawDescGZIP(), []int{9}
}

func (x *ProductObjectDeleteRequest) GetRequestID() *general.RequestID {
	if x != nil {
		return x.RequestID
	}
	return nil
...
func (x *ProductObjectDeleteRequest) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *ProductObjectDeleteRequest) GetBranch() string {
	if x != nil {
		return x.Branch
	}
	return ""
...
type ProductObjectDeleteResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ProductObjectDeleteResponse) Reset() {
	*x = ProductObjectDeleteResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_artifact_v1_products_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ProductObjectDeleteResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductObjectDeleteResponse) ProtoMessage() {}

func (x *ProductObjectDeleteResponse) ProtoReflect() protoreflect.Message {
	mi := &file_artifact_v1_products_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductObjectDeleteResponse.ProtoReflect.Descriptor instead.
func (*ProductObjectDeleteResponse) Descriptor() ([]byte, []int) {
	return file_artifact_v1_products_proto_rawDescGZIP(), []int{10}
}
...
var file_artifact_v1_products_proto_rawDesc = []byte{
	...
	0x22, 0x7a, 0x0a, 0x1a, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x4f, 0x62, 0x6a, 0x65, 0x63,
	...
	0x54, 0x79, 0x70, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x42, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x42, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x22, 0x1d, 0x0a, 0x1b,
	0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x44, 0x65, 0x6c,
	0x65, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xb6, 0x03, 0x0a, 0x0e,
	0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x45,
	0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x1c, 0x2e, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63,
	...
	,
	...
	0x6f, 0x6d, 0x2f, 0x59, 0x6f, 0x73, 0x74, 0x61, 0x72, 0x64, 0x65, 0x76, 0x2f, 0x64, 0x65, 0x76,
	0x6f, 0x70, 0x73, 0x2d, 0x73, 0x64, 0x6b, 0x2f, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74,
	0x73, 0x2f, 0x76, 0x31, 0x3b, 0x20, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x62, 0x06,
...
var file_artifact_v1_products_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_artifact_v1_products_proto_goTypes = []interface{}{
	...
	(*ProductObjectDeleteRequest)(nil),  // 9: artifact.ProductObjectDeleteRequest
	(*ProductObjectDeleteResponse)(nil), // 10: artifact.ProductObjectDeleteResponse
	(*general.GppInfo)(nil),             // 11: general.GppInfo
	(*general.PaginateQuery)(nil),       // 12: general.PaginateQuery
...
var file_artifact_v1_products_proto_depIdxs = []int32{
	11, // 0: artifact.ProductListRequest.GppInfo:type_name -> general.GppInfo
	12, // 1: artifact.ProductListRequest.PaginateQuery:type_name -> general.PaginateQuery
	13, // 2: artifact.ProductListRequest.RequestID:type_name -> general.RequestID
	14, // 3: artifact.ProductResponse.CreatedAt:type_name -> google.protobuf.Timestamp
	14, // 4: artifact.ProductResponse.UpdatedAt:type_name -> google.protobuf.Timestamp
	15, // 5: artifact.ProductListResponse.Paginate:type_name -> general.PaginateInfo
	1,  // 6: artifact.ProductListResponse.Items:type_name -> artifact.ProductResponse
	11, // 7: artifact.ProductCreateRequest.GppInfo:type_name -> general.GppInfo
	13, // 8: artifact.ProductCreateRequest.RequestID:type_name -> general.RequestID
	3,  // 9: artifact.ProductCreateRequest.Request:type_name -> artifact.ProductRequest
	11, // 10: artifact.ProductDownloadRequest.GppInfo:type_name -> general.GppInfo
	13, // 11: artifact.ProductDownloadRequest.RequestID:type_name -> general.RequestID
	11, // 12: artifact.ProductObjectMetaRequest.GppInfo:type_name -> general.GppInfo
	13, // 13: artifact.ProductObjectMetaRequest.RequestID:type_name -> general.RequestID
	13, // 14: artifact.ProductObjectDeleteRequest.RequestID:type_name -> general.RequestID
	0,  // 15: artifact.ProductService.List:input_type -> artifact.ProductListRequest
	4,  // 16: artifact.ProductService.Create:input_type -> artifact.ProductCreateRequest
	7,  // 17: artifact.ProductService.GetObjectMeta:input_type -> artifact.ProductObjectMetaRequest
	5,  // 18: artifact.ProductService.DownloadFile:input_type -> artifact.ProductDownloadRequest
	9,  // 19: artifact.ProductService.DeleteCollection:input_type -> artifact.ProductObjectDeleteRequest
	2,  // 20: artifact.ProductService.List:output_type -> artifact.ProductListResponse
	1,  // 21: artifact.ProductService.Create:output_type -> artifact.ProductResponse
	8,  // 22: artifact.ProductService.GetObjectMeta:output_type -> artifact.ProductObjectMetaResponse
	6,  // 23: artifact.ProductService.DownloadFile:output_type -> artifact.ProductDownloadResponse
	10, // 24: artifact.ProductService.DeleteCollection:output_type -> artifact.ProductObjectDeleteResponse
...
func file_artifact_v1_products_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_artifact_v1_products_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProductObjectDeleteRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_artifact_v1_products_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProductObjectDeleteResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
